...
var writeCard = (cardData, callback) =>
{
    ...
    db.none(prepSQL(writeCard), [cardData.goal, cardData.need, cardData.current_solution, cardData.problem, cardData.solution_ideas, cardData.current_benefits, cardData.comment, cardData.email, cardData.var1, cardData.link12, cardData.var2, cardData.link23, cardData.var3])
    .catch((error) => {
