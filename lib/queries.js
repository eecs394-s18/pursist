...
var writeCard = (cardData, callback) =>
{
    ...
    db.none(prepSQL(writeCard), [cardData.goal, cardData.need, cardData.current, cardData.problem, cardData.solution_ideas, cardData.current_benefits, cardData.comments, cardData.email, cardData.goal_tag, cardData.need_tag, cardData.challenge_tag])
    .catch((error) => {
...
var updateCard = (cardData, callback) =>
{
    ...
    db.none(prepSQL(updateCard), [cardData[0], cardData[1], cardData[2], cardData[3]])
    .catch((error) => {
