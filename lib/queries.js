...
var writeCard = (cardData, callback) =>
{
    ...
    db.none(prepSQL(writeCard), [cardData.goal, cardData.need, cardData.current, cardData.problem, cardData.solution_ideas, cardData.current_benefits, cardData.comments, cardData.email, cardData.var1, cardData.link12, cardData.var2, cardData.link23, cardData.var3, cardData.link34, cardData.var4, cardData.link45, cardData.var5])
    .catch((error) => {
...
var updateCard = (cardData, callback) =>
{
    ...
    //UPDATE: [id, var1, ....]
    db.none(prepSQL(updateCard), [cardData[0], cardData[1], cardData[2], cardData[3], cardData[4], cardData[5]])
    .catch((error) => {
