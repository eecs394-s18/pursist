...
var writeCard = (cardData, callback) =>
{
    ...
    db.none(prepSQL(writeCard), [cardData.goal, cardData.need, cardData.current, cardData.problem, cardData.comment, cardData.email, cardData.goal_tag, cardData.need_tag, cardData.challenge_tag])
    .catch((error) => {
...
var updateCard = (cardData, callback) =>
{
    ...
    db.none(prepSQL(updateCard), [cardData.goal, cardData.need, cardData.current, cardData.problem, cardData.comment, cardData.email, cardData.goal_tag, cardData.need_tag, cardData.challenge_tag])
    .catch((error) => {
